        ...
        <div className="flex items-center justify-center bg-gray-100 min-h-screen">
            <div className="bg-white p-8 rounded-lg shadow-lg md:my-5 w-full max-w-7xl overflow-y-auto max-h-screen">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full border rounded-lg p-2 mt-1 pr-10 focus:outline-none focus:ring-2 focus:ring-primary"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-3 text-gray-400 hover:text-primary"
                                >
                                    {showTransactionalPassword ? <FiEyeOff size={20} /> : <FiEye size={20} />}
                                </button>
                            </div>
                        </div>
                        <div>
                    ...
                    <button
                        type="submit"
                        className="w-full transition-transform hover:scale-105 transform bg-primary text-white font-bold py-3 rounded-lg hover:bg-primary"
                        disabled={loading}
                    >
