    ...
    return (
      <div className="bg-white md:overflow-hidden">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl md:mx-4 md:my-6 mx-2 md:p-8 p-4 mt-2 text-gray-800 border border-primary/30 shadow"
        >
            ...
            <div className="flex items-center">
              {profile?.profile_picture ? (
                <img
                  ...
                  alt="Profile"
                  className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 md:mr-6 mr-3 rounded-full object-cover border-4 border-primary/20"
                />
              ) : (
                <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 md:mr-6 mr-3 rounded-full bg-primary/10 border-4 border-primary/20 flex items-center justify-center">
          ...
          {/* desktop */}
          <div className="border-t border-primary/20 mt-4 md:mt-6 gap-3 md:gap-6 sm:flex sm:justify-between text-sm md:text-base hidden md:flex">
            <div className="text-center">
              <p>Wallet Balance</p>
          ...
          {/* mobile */}
          <div className="border-t md:hidden border-primary/20 mt-4 md:mt-6 pt-4 grid gap-2 text-sm md:text-base">
            {/* First Row */}
