    ...
    return (
        <div className="bg-gray-50 p-2 md:p-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-4">
                <p className="text-primary mb-4 rounded-lg border p-4">
            ...
            <button
                ...
                className="w-full bg-primary md:mb-2 mb-52 text-white font-semibold py-3 rounded-lg mt-6 flex items-center justify-center"
                disabled={isLoading}
            >
